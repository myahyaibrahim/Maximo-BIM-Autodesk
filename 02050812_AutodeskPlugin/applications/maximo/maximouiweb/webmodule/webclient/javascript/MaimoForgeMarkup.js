...
IBM.LMV.Markup.SaveDlg = function(
	...
	this.makeMarkupViewScreen = function(
		...
		cell.colSpan     = 4;
		cell.textContent   = IBM.LMV.Strings.DLG_LABEL_MARKUP_DESC;

		row              = dlgTable.insertRow( i++ );
		cell             = row.insertCell();
		cell.colSpan     = 4;
		cell.className   = "maxlmv_DlgText";
		cell.textContent   = this[ "BIMLMVWORKVIEW" ].DESCRIPTION;
		...
		cell.colSpan     = 4;
		cell.className   = "maxlmv_DlgText";
		cell.textContent   = this[ "BIMLMVWORKVIEW" ].DESCRIPTION_LONGDESCRIPTION;
