...
String id = "";
String IMAGE_PATH = "";
String IMAGE_PATH_MAS8 = "";
String CSS_PATH = "";
String CSS_PATH_MAS8 = "";
...
IMAGE_PATH_MAS8 = servletBase + "/"+skin_mas8+"images/"+(rtl?"rtl/":"")+wcs.getImagePath();
CSS_PATH   = servletBase + "/"+skin+"css/"+(rtl?"rtl":"")+wcs.getCssPath();
CSS_PATH_MAS8   = servletBase + "/"+skin_mas8+"css/"+(rtl?"rtl":"")+wcs.getCssPath();
...
// the viewer will be sized this many pixels smaller to avoid scrollbars
tmp        		 		= bldgMdl.getProperty("viewer_width_offset");
tmp 					= ((tmp == null || tmp.equalsIgnoreCase("")) ? "0" : tmp);
int viewer_width_offset = Integer.parseInt( tmp );
tmp        		 		= bldgMdl.getProperty("viewer_height_offset");
tmp 					= ((tmp == null || tmp.equalsIgnoreCase("")) ? "0" : tmp);
int viewer_height_offset = Integer.parseInt( tmp );
