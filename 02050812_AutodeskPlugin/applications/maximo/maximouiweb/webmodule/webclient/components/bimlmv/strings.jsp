...
private static class StringTable
{
    ...
    final String dlgTextShowDefectMarkupsInformation1;
    final String dlgTextShowDefectMarkupsInformation2;
    final String dlgTextEnterMarkupModeInformation1;
    final String dlgTextEnterMarkupModeInformation2;
    final String dlgTextCannotDeleteView;
    final String dlgTextErrRestDeleteView;
    ...
    final String applySavedView;
    final String saveCurrentView;
		...
		throws MXException, RemoteException
	{
        ...
        dlgTextShowDefectMarkupsInformation1 = server.getMessage(group, "DLG_TEXT_SHOW_DEFECTMARKUPS_INFORMATION1", langCode);
        dlgTextShowDefectMarkupsInformation2 = server.getMessage(group, "DLG_TEXT_SHOW_DEFECTMARKUPS_INFORMATION2", langCode);
        dlgTextEnterMarkupModeInformation1 = server.getMessage(group, "DLG_TEXT_ENTER_MARKUP_MODE_INFORMATION1", langCode);
        dlgTextEnterMarkupModeInformation2 = server.getMessage(group, "DLG_TEXT_ENTER_MARKUP_MODE_INFORMATION2", langCode);
        dlgTextCannotDeleteView = server.getMessage(group, "CANNOT_DELETE_VIEW", langCode);
        dlgTextErrRestDeleteView = server.getMessage(group, "ERR_REST_DELETE_VIEW", langCode);     
        ...
        applySavedView  	   = server.getMessage(group, "APPLY_SAVED_VIEW", langCode);
        saveCurrentView 	   = server.getMessage(group, "SAVE_CURRENT_VIEW", langCode);
        assetNumber     	   = server.getMessage(group, "ASSET_NUMBER", langCode);
        locationNumber  	   = server.getMessage(group, "LOCATION_NUMBER", langCode);
...
%>
        ...
        IBM.LMV.Strings.DLG_TEXT_SHOW_DEFECTMARKUPS_INFORMATION1 = "<%=stringTable.dlgTextShowDefectMarkupsInformation1%>";
        IBM.LMV.Strings.DLG_TEXT_SHOW_DEFECTMARKUPS_INFORMATION2 = "<%=stringTable.dlgTextShowDefectMarkupsInformation2%>";
        IBM.LMV.Strings.DLG_TEXT_ENTER_MARKUP_MODE_INFORMATION1 = "<%=stringTable.dlgTextEnterMarkupModeInformation1%>";
        IBM.LMV.Strings.DLG_TEXT_ENTER_MARKUP_MODE_INFORMATION2 = "<%=stringTable.dlgTextEnterMarkupModeInformation2%>";
        IBM.LMV.Strings.CANNOT_DELETE_VIEW = "<%=stringTable.dlgTextCannotDeleteView%>";
        IBM.LMV.Strings.ERR_REST_DELETE_VIEW = "<%=stringTable.dlgTextErrRestDeleteView%>";
        ...
        IBM.LMV.Strings.APPLY_SAVED_VIEW           = "<%=stringTable.applySavedView%>";
        IBM.LMV.Strings.SAVE_CURRENT_VIEW          = "<%=stringTable.saveCurrentView%>";
        IBM.LMV.Strings.ASSET_NUMBER               = "<%=stringTable.assetNumber%>";
        IBM.LMV.Strings.LOCATION_NUMBER            = "<%=stringTable.locationNumber%>";
